...
See the master branch of this gem.

== Rails 2 Compatibility

You will need to install this gem from the 2.x branch.

To use the Rails 2 compatible version of this gem, please add it to your Gemfile:

    gem "mobile-fu", "2.0.1"

Then, tell Rails to load the gem in config/environment.rb:

    config.gem "mobile-fu", :version=>'=2.0.1'
...
is making the request. Additionally, a generic mobile stylesheet is loaded.
  ...
  stylesheet_blackberry.css has highest precedence, with stylesheet_mobile.css as second,
  and stylesheet.css third.
